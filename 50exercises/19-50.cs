...
* deve ser lido um novo valor e informar valor "Invalido", e imprimir o resultado do primeiro valor pelo segundo
*/
double divisor = 0;
...
{
   Console.WriteLine("Valor invalido, insira um novo valor:");
   divisor = double.Parse(Console.ReadLine());
}
